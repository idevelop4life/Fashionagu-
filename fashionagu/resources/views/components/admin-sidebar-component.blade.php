 ...
 <div class="leftbar-tab-menu">
    <div class="main-icon-menu">
        <a href="index.html" class="logo logo-metrica d-block text-center">
            <span>
                <img src="/admin_assets/images/logo-sm.png" alt="logo-small" class="logo-sm">
            </span>
        </a>
        ...
        <form action="{{route('logout')}}" method="POST">
                ...
                <button type="submit" style="background-color: #555;">
                    <i style="background-color: #555; font-size: 25px" class="ti ti-logout"></i>
                </button>
        </form>
    ...
    <div class="main-menu-inner">
        ...
        <div class="topbar-left">
            <a href="index.html" class="logo">
                <span>
                    <img src="/admin_assets/images/logo-dark.png" alt="logo-large" class="logo-lg logo-dark">
                    <img src="/admin_assets/images/logo.png" alt="logo-large" class="logo-lg logo-light">
                </span>
            </a><!--end logo-->
        </div><!--end topbar-left-->
        <!--end logo-->
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse " id="sidebarAnalytics">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('a_allUsersView')}}" class="nav-link ">All Users</a>
                                    </li><!--end nav-item-->

                                    {{-- <li class="nav-item">
                                        <a href="{{route('all_users')}}" class="nav-link ">All Users</a>
                                    </li><!--end nav-item-->
                                    <li class="nav-item">
                                        <a href="{{route('active_users')}}" class="nav-link ">Active Users</a>
                                    </li><!--end nav-item-->
                                    <li class="nav-item">
                                        <a href="{{route('all_trx')}}" class="nav-link ">Transactions</a>
                                    </li><!--end nav-item--> --}}
                                </ul><!--end nav-->
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse " id="sidebarAnalytics">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('v_addProductsView')}}" class="nav-link ">Add Products</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('v_allProductsView')}}" class="nav-link ">All Products</a>
                                    </li>
