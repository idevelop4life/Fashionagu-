                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Products Edited here will be displayed on your store and
                                        in the market please. Take caution in entering the details. Although, for your
                                        convinience, should you make any error you can always re-edit.
                                    </p>
                                </div>
                                <!--end card-header-->
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <form action="{{route('v_editProduct', $product->id)}}" method="POST">
                                                @csrf
                                                <div class="mb-3 row">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" name="vendor"
                                                            placeholder="Enter vendor name."  value="{{$product->vendor}}" id="example-text-input">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="mb-3">
                                                            <textarea class="form-control"
                                                                ...
                                                                name="description" rows="5" id="message">{{$product->description}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="in_stock"  class="form-select"
                                                            ...
                                                            <option selected>{{$product->in_stock}}</option>
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-sm-2 col-form-label text-end">Is Deleted ?</label>
                                                    <div class="col-sm-10">
                                                        <select name="is_deleted"  class="form-select"
                                                            aria-label="Default select example">
                                                            <option selected>{{$product->is_deleted}}</option>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="package"  class="form-select"
                                                            aria-label="Default select example">
                                                            <option selected>{{$product->package}}</option>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="color" value="{{$product->color}}" class="form-control form-control-color"
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 text-end">
                                                        <button type="submit" class="btn btn-de-primary px-4">Edit Product</button>
                                                    </div>
                                                </div>
                                            </form>
