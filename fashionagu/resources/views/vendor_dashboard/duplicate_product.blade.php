                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Duplicate Product</h4>
                                    <p class="text-muted mb-0">Products Duplicated here will be displayed on your store and
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <form action="{{route('v_duplicateProduct', $product->id)}}" method="POST">
                                                @csrf
                                                <div class="mb-3 row">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 text-end">
                                                        <button type="submit" class="btn btn-de-primary px-4">Duplicate Product</button>
                                                    </div>
                                                </div>
                                            </form>
